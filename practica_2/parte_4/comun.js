...
//  var serverUrl    = "http://cphoto.uji.es/vj1221/assets/textures/";
  var serverUrl    = "texturas/";  // para servidor local
...
function initHandlers() {
  ...
  var menuNormalMaps = document.getElementById("normalmaps");

  if (menuNormalMaps != null) {
    menuNormalMaps.addEventListener("change", 
    function() {
      switch (this.value) {
        case "Acolchado": normalMapSeleccionado =  7; break;
        case "Circuito":  normalMapSeleccionado =  8; break;
        case "Circulos":  normalMapSeleccionado =  9; break;
        case "Dragon":    normalMapSeleccionado = 10; break;
        case "Ondas":     normalMapSeleccionado = 11; break;
      } 
      requestAnimationFrame(drawScene);
    }, false);
  }
